...
a.gen,a.genmed,a.gensmall { color: #1354ad; text-decoration: none; }
a.gen:hover,a.genmed:hover,a.gensmall:hover	{ color: #1354ad; text-decoration: underline; }
...
.cattitle		{ font-weight: bold; font-size: {T_FONTSIZE3}px ; letter-spacing: 1px; color : #3c3c3c}
a.cattitle		{ text-decoration: none; color : #3c3c3c; }
a.cattitle:hover{ text-decoration: underline; }

/* Forum title: Text and link to the forums used in: index.php */
.forumlink		{ font-weight: bold; font-size: {T_FONTSIZE3}px; color : #1354ad; }
a.forumlink 	{ text-decoration: none; color : #1354ad; }
a.forumlink:hover{ text-decoration: underline; color : #1354ad; }
