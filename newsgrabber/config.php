...
define("SITE_KEY", "123456789012345678901234567890");
		// site-key - 64 bytes строка из символов 0-9a-f
...
$_globalLimits["site_structure_levels"] = 2;		// -1 unlim, количество доступных уровней в структуре сайта
$_globalLimits["site_structure_level_items"] = -1;	// -1 unlim, количество доступных страниц на уровень в структуре сайта
$_globalLimits["rss_source_items"] = -1;		// -1 unlim, количество доступных RSS-лент
$_globalLimits["rss_groups_items"] = -1;		// -1 unlim, количество доступных групп для RSS-лент
