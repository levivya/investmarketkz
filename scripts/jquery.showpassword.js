...
;(function($){
	$.fn.showPassword = function(ph, options){
		...
		return this.each(function(){
			var def = { classname: 'class', name: 'password-input', text: 'Показать\\Скрыть пароль' };
			...
			var thecheckbox = '<label><input'+theclass+' type="checkbox" id="'+spcbid+'" name="'+spname+'" value="sp" style="width:15px"/>'+def.text+'</label>';
