...
$bgimg = $_SERVER["DOCUMENT_ROOT"].'/crypt/images/bg-blue.jpg';                 // Le fond du cryptogramme peut-être une image
...
$charel = '0123456789';       // Caractères autorisés

$crypteasy = true;       // Création de cryptogrammes "faciles à lire" (true/false)
                         // composés alternativement de consonnes et de voyelles.

$charelc = '0123456789';   // Consonnes utilisées si $crypteasy = true
$charelv = '0123456789';              // Voyelles utilisées si $crypteasy = true
...
$charspace = 15;        // Espace entre les caracteres (en pixels)
...
$brushsize = 0;        // Taille d'ecriture du princeaiu (en pixels)
...
$cryptusertimererror = 1;  // Action à réaliser si le temps minimum n'est pas respecté:
